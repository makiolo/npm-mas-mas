...
macro(cmaki_setup)
	...
	IF(WITH_CONAN)
		# Conan
		IF(WITH_CONANBUILDINFO)
			message("USANDO $ENV{CMAKI_PWD}/conanbuildinfo.cmake")
			include("$ENV{CMAKI_PWD}/conanbuildinfo.cmake")
		ELSE()
			message("USANDO DEFAULT ${CMAKE_BINARY_DIR}/conanbuildinfo.cmake")
